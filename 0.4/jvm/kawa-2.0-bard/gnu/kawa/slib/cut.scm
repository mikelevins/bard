; In email of 2002-8-26 Al Petrofsky <al@petrofsky.org> sent to the
; srfi-26@srfi.schemers.org mailing list the following:
;
;    I hereby place into the public domain all the code I posted to the
;    SRFI-26 mailing list.
;
;    (The June 4 message is the one from which the reference implementation
;    was trivially derived.)
;
;    -al
