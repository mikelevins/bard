...
public class Bard extends LispLanguage
{
  ...
  public static final Bard instance;
  private static Bard r5rsInstance;
  private static Bard r6rsInstance;
  private static Bard r7rsInstance;
  ...
  /** Evaluate Bard expressions from string.
   * @param string the string containing Bard expressions
  ...
  /** Evaluate Bard expressions from stream.
   * @param port the port to read Bard expressions from
   * @param env the Environment to evaluate the string in
   * @return result of last expression, or Language.voidObject if none. */
  ...
  /** Evaluate Bard expressions from an "S expression."
