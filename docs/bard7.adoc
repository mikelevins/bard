...
What about *classes*? A *class* is a named collection of *structures*. Together, classes and structures comprise Bard's *types*. Classes are abstract types that represent the roles of values in protocols. Structures are concrete descrpitions of how values are constructed.
