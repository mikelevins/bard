...
;;; the value of bard.lang:*module*
(define (get-current-module registry)
  (let ((module (get-module registry 'bard.lang)))
    (lookup-variable module '*module*)))
...
(define (%initial-bard-registry)
  (let ((reg (make-table test: eq?)))
    (define-module reg 'bard.lang)
    (define-module reg 'bard.user)
    (let ((lang-module (get-module reg 'bard.lang))
          (user-module (get-module reg 'bard.user)))
      (define-variable lang-module '*module* value: user-module mutable: #t))
    reg))

(define (%default-initial-module registry)
  (get-module registry 'bard.user))
...
(define (find-in-modules var registry)
  (receive (vname mname)(parse-symbol-name var)
           (let* ((module (if mname 
