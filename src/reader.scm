...
;;; (begin (<syntax>:display (call-with-input-string "'" (lambda (in)(bard:read in))))(newline))
;;; (begin (<syntax>:display (call-with-input-string "," (lambda (in)(bard:read in))))(newline))
;;; (begin (<syntax>:display (call-with-input-string "" (lambda (in)(bard:read in))))(newline))
;;; (begin (<syntax>:display (call-with-input-string "undefined" (lambda (in)(bard:read in))))(newline))
;;; (begin (<syntax>:display (call-with-input-string "nothing" (lambda (in)(bard:read in))))(newline))
;;; (begin (<syntax>:display (call-with-input-string "true" (lambda (in)(bard:read in))))(newline))
;;; (begin (<syntax>:display (call-with-input-string "false" (lambda (in)(bard:read in))))(newline))
;;; (begin (<syntax>:display (call-with-input-string "1" (lambda (in)(bard:read in))))(newline))
;;; (begin (<syntax>:display (call-with-input-string "1.23" (lambda (in)(bard:read in))))(newline))
;;; (begin (<syntax>:display (call-with-input-string "1/2" (lambda (in)(bard:read in))))(newline))
;;; (begin (<syntax>:display (call-with-input-string "\\c" (lambda (in)(bard:read in))))(newline))
;;; (begin (<syntax>:display (call-with-input-string "\\space" (lambda (in)(bard:read in))))(newline))
;;; (begin (<syntax>:display (call-with-input-string "\\u+0020" (lambda (in)(bard:read in))))(newline))
;;; (begin (<syntax>:display (call-with-input-string "\\u+0061" (lambda (in)(bard:read in))))(newline))
;;; (begin (<syntax>:display (call-with-input-string "Foo" (lambda (in)(bard:read in))))(newline))
;;; (begin (<syntax>:display (call-with-input-string "bard.core:Foo" (lambda (in)(bard:read in))))(newline))
;;; (begin (<syntax>:display (call-with-input-string "\"Foo, bar!\"" (lambda (in)(bard:read in))))(newline))
;;; (begin (<syntax>:display (call-with-input-string "(+ 2 3)" (lambda (in)(bard:read in))))(newline))
;;; (begin (<syntax>:display (call-with-input-string "[+ 2 3]" (lambda (in)(bard:read in))))(newline))
;;; (begin (<syntax>:display (call-with-input-string "{+ 2 - 3}" (lambda (in)(bard:read in))))(newline))
