...
(define (bard:read-number/keyword/symbol re c)
  (let ((start-pos (##readenv-current-filepos re)))
    ...
    (let ((obj (##build-delimited-number/keyword/symbol re c #t)))
      (cond 
       ((eqv? obj 'undefined) (macro-readenv-wrap re (ast:undefined)))
       ((eqv? obj 'nothing) (macro-readenv-wrap re (ast:nothing)))
       ((eqv? obj 'true) (macro-readenv-wrap re (ast:boolean #t)))
       ((eqv? obj 'false) (macro-readenv-wrap re (ast:boolean #f)))
...
;;; ----------------------------------------
;;; singletons
;;;(define $x0 (bard:%read-syntax (open-input-string "undefined")))
;;; $x0
;;;(define $x1 (bard:%read-syntax (open-input-string "nothing")))
;;; $x1
;;; ----------------------------------------
;;; booleans
;;;(define $x2 (bard:%read-syntax (open-input-string "true")))
;;; $x2
;;;(define $x3 (bard:%read-syntax (open-input-string "false")))
;;; $x3
;;; ----------------------------------------
;;; characters
;;;(define $x4 (bard:%read-syntax (open-input-string "\\c")))
;;; $x4
;;;(define $x5 (bard:%read-syntax (open-input-string "\\space")))
;;; $x5
;;; ----------------------------------------
;;; numbers
;;;(define $x4 (bard:%read-syntax (open-input-string "1")))
;;; $x4
;;;(define $x5 (bard:%read-syntax (open-input-string "1234567890")))
;;; $x5
;;;(define $x6 (bard:%read-syntax (open-input-string "12345.67890")))
;;; $x6
;;;(define $x7 (bard:%read-syntax (open-input-string "12345/67890")))
;;; $x7
;;; ----------------------------------------
;;; names
;;;(define $x8 (bard:%read-syntax (open-input-string "foo")))
;;; $x8
;;;(define $x9 (bard:%read-syntax (open-input-string "bard.core:foo")))
;;; $x9
;;;(define $x10 (bard:%read-syntax (open-input-string ":foo")))
;;; $x10
;;; ----------------------------------------
;;; sequences
;;;(define $x11 (bard:%read-syntax (open-input-string "[]")))
;;; $x11
;;;(define $x12 (bard:%read-syntax (open-input-string "[0 1 2 3]")))
;;; $x12
;;;(define $x13 (bard:%read-syntax (open-input-string "(+ 1 2 3)")))
;;; $x13
;;; ----------------------------------------
;;; records
;;; ----------------------------------------
;;;(define $x14 (bard:%read-syntax (open-input-string "{}")))
;;; $x14
