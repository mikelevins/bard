...
(define-type stretchy-vector
  id: 920039BD-356E-419A-9C3B-A482A226F32D
...
(define (make-stretchy-vector count #!key (initial-element #f)(fill-pointer #f)(extend-count #f))
...
(define (vector-clear! sv)
  (stretchy-vector-fill-pointer-set! sv 0))
