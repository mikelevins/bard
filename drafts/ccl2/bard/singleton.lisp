...
(defmethod ccl:validate-superclass ((class singleton-class)(superclass standard-class)) t)
(defmethod ccl:validate-superclass ((class singleton-class)(superclass singleton-class)) t)
(defmethod ccl:validate-superclass ((class standard-class)(superclass singleton-class)) nil)
