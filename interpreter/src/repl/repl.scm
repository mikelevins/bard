...
(define (display-error err)
  (let ((msg (cond
              ...
              ((expression-parsing-exception? err) 
               (string-append "error parsing an expression: " (object->string (expression-parsing-exception-kind err)) " "
              ...
              ((type-exception? err)
               (string-append "error parsing an expression: " (object->string (type-exception-procedure err)) " "
